...
const CONTRACT_NAME: &str = "crates.io:certificates-contract";
...
pub fn instantiate(
    ...
    CERTIFICATE.save(deps.storage, &state)?;

    Ok(Response::new()
        .add_attribute("method", "instantiate")
        .add_attribute("owner", info.sender)
        .add_attribute("id", '0'.to_string()))
}
...
pub fn query(deps: Deps, _env: Env, msg: QueryMsg) -> StdResult<Binary> {
    match msg {
        QueryMsg::GetTokenUri { id } => to_binary(&query_token_uri(deps, id)?),
    }
}
